...
def generate_ai_reply(candidate_text):
    ...
    2. ФИЛЬТРАЦИЯ ПО ОПЫТУ И ВОЗРАСТУ (ВАЖНО!): 
       - Если по возрасту подходит (25–40 лет), но **нет опыта в продажах** или опыт минимальный/другой — **НИ В КОЕМ СЛУЧАЕ не ставь статус «Не подходит»**. Ставь статус **«Подумать»**, мягко принимай информацию и говори, что HR-менеджер свяжется для уточнения деталей. Люди без прямого опыта могут подойти на усмотрение рекрутера!
    3. ФИНАЛ ДЛЯ ПОДХОДЯЩИХ И «ПОДУМАТЬ»: 
       - Если кандидат подтверждает возраст и условия / согласен на созвон / или у него нет опыта, но возраст подходящий — ты кратко отвечаешь и сразу ставишь точку: предлагаешь созвониться и говоришь, что HR свяжется.
       - Пример ответа: «Отлично! Передал ваш контакт HR-менеджеру, скоро вам позвонят для короткого созвона».
       - Больше вопросов задавать не нужно, ждем звонка рекрутера.
    4. Если в сообщении кандидата нет информации о возрасте или опыте — мягко уточни это.
